...
$select = "SELECT * FROM students INNER JOIN major ON students.majorid = major.majorid where students.MajorID=1" ;
...
INNER JOIN students ON studentteam.StudentID=students.StudentID where students.MajorID=1";
